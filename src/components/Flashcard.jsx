    ...
    <>
      ...
      <h4>{cards[count].flashCardName}</h4>
        ...
        <div className="mt-4 flex gap-4 items-center">
          <div>
            <button className="px-4 py-2 bg-blue-900 text-white rounded-full shadow-md" onClick={handlePrevious}>
              <GiPreviousButton />
            </button>
          </div>
          <h4 className="font-bold">{count + 1} / {length}</h4>
          <div>
            <button className="px-4 py-2 bg-blue-900 text-white rounded-full shadow-md" onClick={handleNext}>
              <GiNextButton />
            </button>
          </div>
        </div>
      ...
      <div className='flex justify-between'> 
        <div className='pl-10 w-[150px]'><img src="/logo2.png" alt="" /></div>  
        <div className='flex w-[500px] items-center gap-20'> 
          {toggleFlash && (
            <button className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600" onClick={() => setToggleFlash(false)}>Close</button>
          )}
          <div className='w-[200px] flex justify-start'>
            <img  onClick={handleToggleFlash} className='w-[120px] h-30' src="/logo3.png" alt="" />
          </div>
        </div>
      </div>
    </>
